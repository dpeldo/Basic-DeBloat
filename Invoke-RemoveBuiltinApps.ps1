...
foreach ($App in $AppArrayList) {
    ...
    if (($App.Name -in $WhiteListedApps)) {
        ...
        if ($AppPackageFullName -ne $null) {
            ...
            try {
                    # Gather package name using App Name
					Write-LogEntry -Value "--Gathering Package Names Using App Name"
...
$WhiteListOnDemand = "Microsoft.Windows.Camera|Microsoft.Windows.Notepad|Microsoft.Windows.MSPaint|Microsoft.Windows.PowerShell|Microsoft.Windows.Wordpad|NetFX3|Tools.Graphics.DirectX|Tools.DeveloperMode.Core|Language|Browser.InternetExplorer|ContactSupport|OneCoreUAP|Media.WindowsMediaPlayer"
